...
public class TypeMode extends IntegerType {
	public static interface IModeWrapper {
		...
		public IModeWrapper setMode(final NodeType type,
				final boolean ownerReadable, final boolean ownerWritable,
				final boolean ownerExecutable, final boolean groupReadable,
				final boolean groupWritable, final boolean groupExecutable,
				final boolean otherReadable, final boolean otherWritable,
	...
	public static final class ModeWrapper implements IModeWrapper {
		...
		public final ModeWrapper setMode(final NodeType type) {
			return setMode(type, true, true, true, true, true, true, true,
					true, true);
		}
		...
		public final ModeWrapper setMode(final NodeType type,
				final boolean readable, final boolean writable,
				final boolean executable) {
			return setMode(type, readable, writable, executable, readable,
		...
		public final ModeWrapper setMode(final NodeType type,
			...
			mode |= (ownerReadable ? S_IRUSR : 0L)
					| (ownerWritable ? S_IWUSR : 0L)
					| (ownerExecutable ? S_IXUSR : 0L);
			mode |= (groupReadable ? S_IRGRP : 0L)
					| (groupWritable ? S_IWGRP : 0L)
					| (groupExecutable ? S_IXGRP : 0L);
			mode |= (otherReadable ? S_IROTH : 0L)
					| (otherWritable ? S_IWOTH : 0L)
					| (otherExecutable ? S_IXOTH : 0L);
			return mode(mode);
		}
